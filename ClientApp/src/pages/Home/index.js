...
class Home1 extends Component {
 ...
 componentDidMount() {
  ...
  console.log(this.props);
    ...
    return (
      <>
        <main className="home col-xxl-10 m-xxl-auto col-xl-7 m-xl-auto col-lg-8 col-md-8 m-md-auto col-sm-11 m-sm-auto col-12 m-auto">
...
export const Home = withRouter(Home1);